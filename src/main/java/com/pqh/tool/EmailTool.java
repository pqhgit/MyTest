...
public class EmailTool {
    public static void send(String toEmail, int i, String activecode) throws MessagingException{
        ...
        msg.setSubject("eastphil帐号激活");
        // 设置邮件内容

        ///邮件的内容
        //http://localhost:8090/activeUser?userId="+userId+"&activecode="+activecode
        StringBuffer sb=new StringBuffer("这是一封由eastphil发送的注册验证邮件！点击下面url完成验证：</br>");
        sb.append("<a href=\"http://localhost:8088/activeUser?userId=");
        sb.append(i);
        sb.append("&activecode=");
        sb.append(activecode);
        sb.append("\">http://localhost:8088/activeUser?userId=");
        sb.append(i);
        sb.append("&activecode=");
        sb.append(activecode);
        sb.append("</a>");
